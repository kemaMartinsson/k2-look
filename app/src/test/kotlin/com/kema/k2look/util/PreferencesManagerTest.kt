...
/** Unit tests for PreferencesManager Tests all preference storage and retrieval functionality */
class PreferencesManagerTest {
    ...
    @Test
    fun `isAutoConnectActiveLookEnabled returns default true`() {
        every { sharedPreferences.getBoolean("auto_connect_activelook", true) } returns true
