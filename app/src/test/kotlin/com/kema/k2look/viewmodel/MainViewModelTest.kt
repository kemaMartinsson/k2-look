...
/**
 * Unit tests for MainViewModel Tests UI state data structures and validation logic
 *
 * Note: Full ViewModel testing would require dependency injection framework These tests focus on
 * the data structures and validation logic
 */
