...
fun LayoutTemplateSelectorDialog(
    ...
    AlertDialog(
            ...
            text = {
                Column(
                        modifier = Modifier.heightIn(max = 450.dp).verticalScroll(scrollState),
            ...
            confirmButton = {
                Row(
                    ...
                    if (scrollState.value < scrollState.maxValue && scrollState.maxValue > 0) {
                        ...
                        ) // Placeholder when no scroll indicator
                    }
        ...
        Row(
            ...
            template.preview?.let { previewRes ->
                Image(
                        ...
                        modifier = Modifier.size(100.dp, 80.dp).padding(end = 16.dp)
                )
            }
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Text(
                        text =
                                "${template.maxFields} data field${if (template.maxFields > 1) "s" else ""}",
