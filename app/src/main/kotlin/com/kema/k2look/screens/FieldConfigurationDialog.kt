                ...
                Column(
                    ...
                    MetricSelector(
                            ...
                            onDataFieldSelected = { newField ->
                                ...
                                if (visualizationType == VisualizationType.GAUGE &&
                                                !canShowAsGauge(newField)
                                ) {
                                    visualizationType = VisualizationType.TEXT
                                }
                                if (visualizationType == VisualizationType.BAR &&
                                                !canShowAsBar(newField)
                                ) {
                                    visualizationType = VisualizationType.TEXT
                                }
                                if (visualizationType == VisualizationType.ZONED_BAR &&
                                                !canShowAsZonedBar(newField)
                                ) {
                                    visualizationType = VisualizationType.TEXT
                                }
                            }
                    ...
                    if (visualizationType == com.kema.k2look.model.VisualizationType.TEXT) {
                        ...
                        Row(
                            ...
                            Column(modifier = Modifier.weight(1f)) {
                                Text(text = "Show Unit", style = MaterialTheme.typography.bodyLarge)
                                Text(
                        ...
                        if (visualizationType == com.kema.k2look.model.VisualizationType.TEXT) {
                            ...
                            Row(
                                ...
                                Column(modifier = Modifier.weight(1f)) {
                                    ...
                                    Text(
                                            text =
                                                    if (selectedDataField.icon28 != null ||
                                                                    selectedDataField.icon40 != null
                                                    ) {
                                                        val currentIconSize =
                                ...
                                Switch(
                                        ...
                                        onCheckedChange = {
                                            showIcon = it
                                            // When enabling icon, keep current size (default is
                                            // SMALL)
                                            // User can toggle to LARGE if they want
                                        },
                                        enabled =
                                                selectedDataField.icon28 != null ||
                                                        selectedDataField.icon40 != null
                                )
                            }
                            ...
                            if (selectedDataField.icon40 != null) {
                                Row(
                                    ...
                                    Column(modifier = Modifier.weight(1f)) {
                                        ...
                                        Text(
                                                text =
                                                        if (iconSize == IconSize.LARGE) "40×40px"
                                                        else "28×28px",
                                                style = MaterialTheme.typography.bodySmall,
                                                color =
                                                        MaterialTheme.colorScheme.onSurface.copy(
                ...
                Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.End) {
                    ...
                    Button(
                            onClick = {
                                ...
                                val (gauge, progressBar, zonedBar) =
                                        when (visualizationType) {
                                            com.kema.k2look.model.VisualizationType.GAUGE -> {
                                                ...
                                                // Get metric-specific template or create generic
                                                // one
                                                val baseGauge =
                                                        when (selectedDataField.id) {
                                                            7 -> {
                                                                android.util.Log.i(
                                                                        "FieldConfig",
                                                                        "    Using Power gauge template"
                                                                )
                                                                com.kema.k2look.data
                                                            ...
                                                            8 -> {
                                                                ...
                                                                // Create generic gauge for other
                                                                // metrics
                                                ...
                                                // Update the gauge's dataField to use the selected
                                                // one
                                                val updatedGauge =
                                                        baseGauge.copy(
                                                                dataField = selectedDataField
                                            ...
                                            com.kema.k2look.model.VisualizationType.BAR -> {
                                                ...
                                                val baseBar =
                                                        when (selectedDataField.id) {
                                                            ...
                                                            12 -> {
                                                                ...
                                                                // Create generic horizontal bar for
                                                                // other metrics
                                                ...
                                                // Update the bar's dataField to use the selected
                                                // one
                                                val updatedBar =
                                                        baseBar.copy(dataField = selectedDataField)
                                                android.util.Log.i(
                                                        "FieldConfig",
...
/**
 * Check if a metric can be displayed as a gauge Now supports ALL metrics with generic gauge
 * templates
 */
...
/**
 * Check if a metric can be displayed as a simple bar Now supports ALL metrics with generic bar
 * templates
 */
