 ...
 *
 * These defaults provide ready-to-use visualizations that users can apply without needing to
...
object DefaultVisualizations {
         ...
         *
         * Visual: Arc from 3 o'clock around to 6 o'clock (270°) Center display area for text value
         */
         ...
         *
         * Visual: Arc showing HR relative to max HR Can be combined with text showing actual BPM
         */
         ...
         *
         * Visual: Horizontal bar showing all HR zones with different grey levels Current HR
         * position highlighted
         *
         * Default zones based on typical percentages of max HR (190 bpm example): Z1: 40-114 bpm
         * (50-60%) - Recovery Z2: 114-133 bpm (60-70%) - Endurance Z3: 133-152 bpm (70-80%) - Tempo
         * Z4: 152-171 bpm (80-90%) - Threshold Z5: 171-200 bpm (90-100%) - Max
         */
         ...
         *
         * Visual: Horizontal bar showing all power zones based on FTP Current power position
         * highlighted
         *
         * Power zones based on typical FTP percentage ranges: Z1: 0-140W (0-55% FTP) - Active
         * Recovery Z2: 140-190W (55-75% FTP) - Endurance Z3: 190-220W (75-90% FTP) - Tempo Z4:
         * 220-260W (90-105% FTP)- Lactate Threshold Z5: 260-300W (105-120% FTP)- VO2 Max Z6:
         * 300-360W (120-150% FTP)- Anaerobic Capacity Z7: 360-400W (150%+ FTP) - Neuromuscular
         * Power
         *
         * Note: These zones assume FTP ≈ 250W. Karoo automatically adjusts based on user's actual
         * FTP.
         */
